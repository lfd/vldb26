...
def conduct_experiments_template(benchmarks, max_depth, num_right_leaf_predecessors, threshold_index, problem_path_prefix, result_path_prefix):
    for benchmark in benchmarks:
        ...
        for query in queries:
            ...
            result_path = result_path_prefix + '/' + benchmark + '/q' + str(query_number) + '/maxdepth_' + str(max_depth) + '/thresh_' + str(threshold_index) + '/' + str(num_right_leaf_predecessors) + '_right_pred'
...
if __name__ == "__main__":
    ...
    conduct_experiments_template(benchmarks, max_depth, num_right_leaf_predecessors, threshold_index, problem_path_prefix, result_path_prefix)
