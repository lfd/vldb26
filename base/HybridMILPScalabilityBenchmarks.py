...
def conduct_experiments_template(graph_types, relations, problems, max_depth, num_right_leaf_predecessors, problem_path_prefix, threshold_path_prefix, time_limit, result_path_prefix):
    for graph_type in graph_types:
        for i in relations:
            for j in problems:
                ...
                threshold_path = threshold_path_prefix + '/' + graph_type + '_graph/' + str(i) + 'relations/' + str(j)
...
if __name__ == "__main__":
    ...
    subproblem_path = 'Adaptive/queries/subproblems'
    subproblem_solutionpath = 'Experiments/Subproblem_Solutions'
    graph_types = ['TREE']
    ...
    conduct_experiments_template(graph_types, relations, problems, max_depth, num_right_leaf_predecessors, problem_path_prefix, threshold_path_prefix, time_limit, result_path_prefix)
    HybridUtil.parse_results_for_subproblems(graph_types, relations, problems, max_depth, num_right_leaf_predecessors, time_limit, raw_problem_path, problem_path_prefix, result_path_prefix, subproblem_path)
